            ...
            <div class="account-settings">
                <div class="user-profile">
                    <div class="user-avatar">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($_SESSION['profilePicture']); ?>" alt="Maxwell Admin">
                    </div>
                    <h5 class="user-name"><?php echo $_SESSION['firstName'] ." ". $_SESSION['lastName'] ?></h5>
                    <h6 class="user-email"><?php echo $_SESSION['email'] ?></h6>
                </div>
                <div class="user-profile">
                    <div class="user-avatar">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($_SESSION['licensePicture']); ?>" alt="Maxwell Admin">
                    </div>
                    <h5 class="user-name">License Photo</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h6 class="mt-3 mb-2 text-primary">Address Information</h6>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                                ...
                                <option value="<?php echo $_SESSION['state'] ?>" disabled selected><?php echo $_SESSION['state'] ?></option>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h6 class="mb-2 text-primary">Update Images</h6>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
